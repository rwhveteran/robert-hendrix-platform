...
export const mobileApps = [
  { name: 'Vision Tracker', description: 'Goal visualization and progress tracking', category: 'Productivity' },
  { name: 'Momentum Tracker', description: 'Daily momentum and energy monitoring', category: 'Wellness' },
  { name: 'ADHD Marker App', description: 'Behavioral marker logging and analysis', category: 'Behavioral' },
  { name: 'Veteran Crisis App', description: 'Crisis support and emergency contacts', category: 'Veterans' },
  { name: 'Daily Recovery Tracker', description: 'Recovery milestone tracking', category: 'Recovery' },
  { name: 'Behavioral Signal Monitor', description: 'Real-time behavioral signal detection', category: 'Behavioral' },
  { name: 'Goal Execution Tracker', description: 'Task breakdown and execution monitoring', category: 'Productivity' },
  { name: 'Executive Summary Mobile', description: 'Daily executive function summaries', category: 'Behavioral' },
  { name: 'Thought Capture System', description: 'Quick thought and idea capture', category: 'Productivity' },
  { name: 'Recovery Pathways', description: 'Guided recovery journey tracking', category: 'Recovery' },
]
